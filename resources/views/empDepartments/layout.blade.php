   ...
   <body>
      ...
      <nav class="navbar navbar-expand-lg bg-light">
         <div class="container-fluid">
           <a class="navbar-brand" href="{{ route('empDepartments.index') }}" class="nav-link {{ request()->is('employees*') ? 'active' : '' }}">AdminPanel</a>
           ...
           <div class="collapse navbar-collapse" id="navbarSupportedContent">
             ...
             <div class="mx-auto pull-right">
               <div class="">
                   <form action="{{ route('empDepartments.index') }}" method="GET" role="search">
   
                       <div class="input-group">
                           
                           <input type="text" class="form-control mr-2" name="term" placeholder="Search projects" id="term">
                           <a href="{{ route('empDepartments.index') }}" class=" mt-1">
